...
#define AC_DISPLAY_LOGO_INTERVAL								(5000)
...
#define AC_DISPLAY_SHOW_BALL_ESCAPE_UPDATE_INTERVAL					(100)
#define AC_DISPLAY_SHOW_DVD_UPDATE_INTERVAL							(50)
...
enum {
	...
	AC_DISPLAY_BUTON_MODE_n_UP_RELEASED,
	AC_DISPLAY_BUTON_MODE_n_DOWN_RELEASED,
	...
	AC_DISPLAY_SHOW_BALL_ESCAPE_UPDATE,
	AC_DISPLAY_SHOW_DVD_UPDATE,
	...
	AC_DISPLAY_BUTON_LONG_DOWN_RELEASED,
	AC_DISPLAY_BUTON_LONG_UP_RELEASED,
	AC_DISPLAY_BUTON_LONG_MODE_PRESSED,
	AC_DISPLAY_SHOW_SOCCER_COUNTDOWN,
	AC_DISPLAY_SHOW_SOCCER_PLAY,
	AC_DISPLAY_SHOW_SOCCER_RESULT,
	AC_DISPLAY_SHOW_SOCCER_SUPER_MODE,
...
enum {
	AR_SOCCER_GAME_BALL_TICK_ID = AK_USER_DEFINE_SIG,
	AR_SOCCER_GAME_KEEPER_TICK_ID,
	AR_SOCCER_GAME_STRIKER_TICK_ID,
	AR_SOCCER_GAME_COUNTDOWN_TICK_ID,
	AR_SOCCER_GAME_SUPER_MODE_TICK_ID,
	AR_SOCCER_GAME_RESULT_TICK_ID,
};
